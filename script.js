                    ...
                    fetch(action, options)
                        .then(function(response) {
                            if (response.ok) {
                                ...
                                successMsg.style.cssText = 'color: #38a169; padding: 1rem; margin-top: 1rem; background: #f0fff4; border-radius: 0.25rem;';
                        ...
                        .catch(function() {
                            ...
                            errorMsg.style.cssText = 'color: #e53e3e; padding: 1rem; margin-top: 1rem; background: #fff5f5; border-radius: 0.25rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'df3f064b-57d4-4dd7-a642-90124672d74f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'df3f064b-57d4-4dd7-a642-90124672d74f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'df3f064b-57d4-4dd7-a642-90124672d74f';
